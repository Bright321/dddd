...
insert  into `address`(`id`,`userId`,`address`,`addressDetail`,`isDelete`,`recipients`,`postCode`,`mobile`) values (1,1,'山西省太原市小店区','解放东路振天科技集团14层1402室',1,'周双大','111112',NULL);
...
insert  into `user`(`id`,`username`,`password`,`mobile`,`isDelete`) values (1,'ailiang','lueSGJZetyySpUndWjMBEg==','15102324243',1);
